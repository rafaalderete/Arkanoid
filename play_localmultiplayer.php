<?php
  session_start();
  $_SESSION['prev'] = "play_localmultiplayer.php";
?>
...
<head>
  ...
  <script type="text/javascript" src="js/controls_localmultiplayer.js"></script>
  ...
  <script type="text/javascript" src="js/player_localmultiplayer.js"></script>
